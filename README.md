...
这是一项增量功能；细粒度语法标注、发音播放与收藏不在本期。[设计与边界](docs/superpowers/specs/2026-09-22-word-lookup-design.md)和[小样验证记录](docs/experiments/2026-09-23-word-lookup-spike.md)保留了数据覆盖与模型误差的观察。
